...
const FiveDManualResultSchema = new mongoose.Schema({
    timerName: {
        type: String,
        required: true,
    },
...
const FiveDManualResult = mongoose.model('FiveDManualResult', FiveDManualResultSchema);
module.exports = FiveDManualResult;